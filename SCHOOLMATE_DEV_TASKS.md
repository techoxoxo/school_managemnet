...
| Phase 1       | Core academic MVP                          | 34    | 28   | 🟨      |
...
| P1-MOD-16 | Bulk import v1: Excel template for students+parents, column mapper, dry-run validation, staged commit, rollback by batch tag | P1-MOD-09             | 🟨     | Plan §19 — API done: import_batches + /imports/students (template, dry-run, all-or-nothing commit, rollback-by-batch, +parent link); Excel/mapper UI pending |
