...
| P1-MOD-10 | Student documents: upload, checklist, verification workflow                                                                  | P1-MOD-09             | 🟨     | Backend done: student_documents (S3/MinIO), presigned PUT/GET, required-docs checklist, pending→verified/rejected workflow, delete; verified live (real upload/download); upload widget UI pending        |
