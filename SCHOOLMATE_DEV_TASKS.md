...
| Phase 2       | Fees & examinations                        | 30    | 14   | 🟨      |
...
| P2-MOD-19 | Report card templates: CBSE + generic formats, tenant template config (JSONB layout)                     | P2-MOD-18             | 🟨     | Generic template (lib/report-card-template.ts, HTML-escaped) live. CBSE-specific layout + tenant JSONB template config still pending.                                                       |
