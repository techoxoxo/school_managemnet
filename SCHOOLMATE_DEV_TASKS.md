...
| ID        | Task                                                                                                                         | Depends on            | Status | Notes                     |
| --------- | ---------------------------------------------------------------------------------------------------------------------------- | --------------------- | ------ | ------------------------- |
| P1-MOD-08 | Students schema migration (§4.C: students, documents, class_history, admissions)                                             | P0-DB-05              | ⬜     |                           |
| P1-MOD-09 | Student CRUD: profile, photo upload (MinIO/S3), admission number generator                                                   | P1-MOD-08, P1-MOD-06  | ⬜     |                           |
| P1-MOD-10 | Student documents: upload, checklist, verification workflow                                                                  | P1-MOD-09             | ⬜     |                           |
| P1-MOD-11 | Field-level encryption service (AES-256-GCM, per-tenant keys) — apply to Aadhaar/bank fields                                 | P1-MOD-08             | ⬜     | Plan §13                  |
| P1-MOD-12 | Admission pipeline: application form, status workflow (applied→…→accepted), convert-to-student                               | P1-MOD-09             | ⬜     |                           |
| P1-MOD-13 | Parents schema + CRUD + parent-student linking (M2M, primary contact, pickup rights)                                         | P1-MOD-09             | ⬜     |                           |
| P1-MOD-14 | Parent account auto-provisioning: magic-link invite via SMS/email (no password setup)                                        | P1-MOD-13, P0-AUTH-01 | ⬜     | Plan §19                  |
| P1-MOD-15 | Sibling detection & linking                                                                                                  | P1-MOD-13             | ⬜     | Feeds fee discounts in P2 |
| P1-MOD-16 | Bulk import v1: Excel template for students+parents, column mapper, dry-run validation, staged commit, rollback by batch tag | P1-MOD-09             | ⬜     | Plan §19 — sales-critical |
| P1-MOD-17 | Student search: Meilisearch indexing + advanced filters UI                                                                   | P1-MOD-09             | ⬜     |                           |
